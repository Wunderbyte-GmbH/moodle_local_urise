...
switch ($type) {
    case 'karten':
        echo format_text("[unifiedcards filter=1 search=1 sort=1 sortby=text sortorder=asc requirelogin=false]", FORMAT_HTML);
        break;
    case 'grid':
    ...
    case 'liste':
    default:
        echo format_text("[unifiedlist filter=1 search=1 sort=1 sortby=text sortorder=asc requirelogin=false]", FORMAT_HTML);
        break;
}
