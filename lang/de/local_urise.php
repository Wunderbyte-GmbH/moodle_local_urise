...
$string['excludecourselistindashboard'] = "Kursliste im urise Dashboard ausschließen";
$string['excludecourselistindashboard_desc'] = "Hier können Namen der Kursbreiche eingetragen werden (Komma separiert, ohne Leerzeichen dazwischen). In den hier eingetragenen Bereichen werden keine Kurslisten angezeigt.";
...
$string['fbgermanistiknederlandistikundskandinavistik'] = "FB Germanistik und Skandinavistik";
...
$string['fbosteuropaeischegeschichteundslawistik'] = "FB Osteuropäische Geschichte und Slawistik";
...
$string['informationskommunikation'] = 'Information & Kommunikation';
...
$string['phdstudents'] = "Doctoral Candidates";
...
$string['qualificationforstudent'] = "Peer Competence";
...
$string['shortcodeslistofmybookingoptionsascards'] = 'Liste meiner gebuchten Kurse als Karten';
...
$string['viewcards'] = 'Karten';
$string['viewlist'] = 'Listen';
...
$string['viewtextlist'] = 'Listen (Text)';
...
$string['vuebookingstatsexcused'] = 'Entschuldigt';
$string['vuebookingstatsno'] = 'Nein';
$string['vuebookingstatsnoshow'] = 'No Show';
$string['vuebookingstatsparticipated'] = 'Teilgenommen';
