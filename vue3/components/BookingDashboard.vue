      ...
      <div v-if="content" class="content-container">
        <ul v-cloak id="myTab" class="nav nav-tabs justify-content-center bottomtabs mt-4" role="tablist">
          <li class="nav-item" role="presentation">
            <button id="home-tab" class="nav-link active" data-toggle="tab" data-target="#home" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab"
              aria-controls="home" aria-selected="true">
              {{ store.state.strings.dashboardoverview }}
            </button>
          </li>
          <li v-if="content.showbookingoptionfields" class="nav-item" role="presentation">
            <button id="profile-tab" class="nav-link" data-toggle="tab" data-target="#profile" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab"
              aria-controls="profile" aria-selected="false">
              {{ store.state.strings.dashboardbookingfields }}
            </button>
          </li>
          <!-- <li class="nav-item" role="presentation">
            <button id="contact-tab" class="nav-link" data-toggle="tab" data-target="#contact" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab"
